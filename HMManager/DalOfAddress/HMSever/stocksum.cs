...
namespace DalOfAddress.HMSever
{
    public class Stocksum
    {
        ...
        public static bool ReduceSatoshi(string bitcoinAddr, long satoshiValue, long scoreValue, string msg, string sign, string sha256ID, DateTime msgTime, out string resultMsg)
        {
            bool returnResult;
            using (MySqlConnection con = new MySqlConnection(Connection.ConnectionStr))
            {
    ...
    public class StockMsg
    {
        ...
        public static int GetCountOfRewardReplyInAWeek(string bTCAddress)
        {
